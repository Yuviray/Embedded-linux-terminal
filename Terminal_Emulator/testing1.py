...
def callCommand(user_input, font):
    global prev_lines, max_lines, next_y
...
def openSettings(screen):
    screen.fill(BLACK)

# def main():
#     global BLACK, WHITE, LIGHT_GREY, RED, font_size, screen_width,\
#     screen_height, sidebar_width, button_dim, active, next_y, prev_lines, max_lines
...
#     sidebar_surface.fill(menu_color)

#     # Define menu buttons
#     settings_button = pygame.Rect((sidebar_width - button_dim) / 2, 10, button_dim, button_dim)
#     pygame.draw.rect(sidebar_surface, (button_color), settings_button)
...
#                 pygame.draw.rect(sidebar_surface, 'Red', settings_button, int((sidebar_width - button_dim) / 2), 10)
...
#         # Add side menu
#         screen.blit(sidebar_surface, (screen_width, 0))
#         pygame.draw.rect(sidebar_surface, (button_color), settings_button)
