...
# def callCommand(user_input, font, line_spacing):
...
#                         callCommand(input_text, font, line_spacing)
...
#             screen.blit(previous_surface, (10, i * (font.get_height() + line_spacing)))
